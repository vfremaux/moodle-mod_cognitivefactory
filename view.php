<?PHP  // $Id: view.php,v 1.3 2012-06-19 08:47:03 vf Exp $
    ...
    */
	...
	$url = new moodle_url($CFG->wwwroot.'/mod/cognitivefactory/view.php', array('id' => $id, 'view' => $view, 'page' => $page));
    $PAGE->set_url($url);
...
/// Finish the page
    ...
    echo '<p><center>';
	echo $OUTPUT->single_button(new moodle_url("{$CFG->wwwroot}/course/view.php", $options), $backtocoursestr, 'get');
    echo '</center></p>';
