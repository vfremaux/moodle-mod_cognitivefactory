...
?>
    ...
    <tr>
        ...
        <td align="left" width="50%">
            ...
            helpbutton('operatorrouter.html&amp;operator=filter&amp;helpitem=maxideasleft', get_string('maxideasleft', 'cognitivefactory'), 'cognitivefactory');
            ?>
        </td>
    </tr>
    <tr>
        <td align="right" width="50%"><b><?php print_string('candeletemore', 'cognitivefactory') ?>:</b></td>
        <td align="left" width="50%">
            ...
            <?php helpbutton('operatorrouter.html&amp;operator=filter&amp;helpitem=candeletemore', get_string('candeletemore', 'cognitivefactory'), 'cognitivefactory'); ?>
        </td>
    </tr>
    <tr>
        ...
        <td align="left" width="50%">
            ...
            <?php helpbutton('operatorrouter.html&amp;operator=filter&amp;helpitem=allowreducesource', get_string('allowreducesource', 'cognitivefactory'), 'cognitivefactory'); ?>
        </td>
    </tr>
    <tr>
        <td colspan="2">
