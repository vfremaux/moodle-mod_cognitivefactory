...
print_simple_box(get_string('responses', 'cognitivefactory')." <span id=\"leftcount\">$toeliminate</span>".' '.get_string('responsestoeliminate', 'cognitivefactory'));
...
?>
    <tr>
        <td colspan="2">
            <input type="submit" id="go1" name="go_btn" value="<?php print_string('saveordering', 'cognitivefactory') ?>" />
            &nbsp;<input type="button" name="startproc_btn" value="<?php print_string('startpaircompare', 'cognitivefactory') ?>" onclick="confirmprocedure();" />
            <script language="">
                function confirmprocedure(){
                    if (confirm("<?php print_string('confirmpaircompare', 'cognitivefactory') ?>")){
...
?>
            &nbsp;<input type="button" id="go2" name="reduce_btn" value="<?php print_string('saveorderingandreduce', 'cognitivefactory') ?>" onclick="document.forms['filterform'].what.value='saveandreduce';document.forms['filterform'].submit();" />
<?php
}
?>
        </td>
