...
function locate_get_locations($cognitivefactoryid, $userid=null, $groupid=0, $excludemyself=false){
    ...
    $select = "
        ...
        $accessClause
    ";
    if (!$locations = get_records_select('cognitivefactory_operatordata AS od', $select, '', 'itemsource,blobvalue')){
        $locations = array();
    }
    return $locations;
}
...
*
*/
function locate_display(&$cognitivefactory, $userid, $groupid){
