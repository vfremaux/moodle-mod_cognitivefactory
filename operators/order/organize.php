...
print_heading("<img src=\"{$CFG->wwwroot}/mod/cognitivefactory/operators/{$page}/pix/enabled_small.gif\" align=\"left\" width=\"40\" /> " . get_string('puttingideasinorder','cognitivefactory'));
?>
<center>
<?php
...
?>
    <tr>
        <td colspan="<?php echo $totalspan; ?>">
            <input type="submit" name="go_btn" value="<?php print_string('saveorder', 'cognitivefactory') ?>" />
