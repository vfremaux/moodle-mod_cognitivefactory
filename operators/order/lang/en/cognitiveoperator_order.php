...
$string['pluginname'] = 'Cognitive Operator : Ordering';
...
$string['reorderedrecord'] = 'reordered record';

$string['absolute_help'] = '
<p><b>Parameter:</b> Absolute</p>
<p>When enabled, it will possible to "ex-aequo" some inputs.</p>
';
