...
$strmerge = get_string('mergedata', 'cognitiveoperator_'.$page);
...
$intro .= "<span id=\"leftcount\">".$toeliminate.'</span> '. get_string('responsestokeep', 'cognitiveoperator_'.$page);
...
?>
                            <tr>
                                <td>
                                    <input type="radio" name="choice_<?php p($i) ?>" value="<?php p($response->id) ?>" <?php echo $checked ?>  onclick="choosethis('<?php p($i) ?>', '<?php echo $response->response ?>')" />                        
                                </td>
                                <td align="left">    
                                    "<?php echo $response->response ?>"
                                </td>
...
?>
                            <tr>
                                ...
                                <td align="left">
                                    <?php print_string('custommerge', 'cognitiveoperator_'.$page) ?>
                                </td>
                            </tr>
<?php
    }
