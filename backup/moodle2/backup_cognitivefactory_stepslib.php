...
class backup_cognitivefactory_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $response->annotate_ids('group', 'groupid');
        ...
        $userdatum->annotate_files('mod_cognitivefactory', 'report', 'id'); // This file area has itemid
        $userdatum->annotate_files('mod_cognitivefactory', 'feedback', 'id'); // This file area has itemid
