...
//-------------------------------------------------------------------------------
        ...
        $mform->addGroup($group1, 'collectgroup', get_string('collect', 'cognitivefactory'), ' &nbsp;&nbsp&nbsp;&nbsp;', false);
        ...
        $mform->addGroup($group2, 'preparegroup', get_string('prepare', 'cognitivefactory'), ' &nbsp;&nbsp&nbsp;&nbsp;', false);
        ...
        $mform->addGroup($group3, 'organizegroup', get_string('organize', 'cognitivefactory'), ' &nbsp;&nbsp&nbsp;&nbsp;', false);
        ...
        $mform->addGroup($group4, 'displaygroup', get_string('display', 'cognitivefactory'), ' &nbsp;&nbsp&nbsp;&nbsp;', false);
        ...
        $mform->addGroup($group5, 'feedbackgroup', get_string('feedback', 'cognitivefactory'), ' &nbsp;&nbsp&nbsp;&nbsp;', false);
