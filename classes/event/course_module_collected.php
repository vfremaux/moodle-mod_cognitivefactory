...
class course_module_collected extends \core\event\course_module_viewed {
    ...
    public function create_from_data(&$cognitivefactory, $response) {
        $this->other['responseid'] = $response->id;
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['responseid'])) {
            throw new \coding_exception('The other[\'responseid\'] must be set.');
        }
    }
}
