<?PHP // $Id: cognitivefactory.php,v 1.3 2012-06-19 08:47:04 vf Exp $
      // cognitivefactory.php - created with Moodle 1.8 development (2007122600)

$string['cognitivefactory:addinstance'] = 'Peut ajouter ue instance';
...
$string['cognitivefactory:gradable'] = 'Peut être évalué ';
$string['cognitivefactory:import'] = 'Peut importer des entrées par un fichier';

$string['addmoreresponses'] = 'Ajouter plus d\'idées ';
$string['adminoptions'] = 'Options enseignantes';
...
$string['backtoreportlist'] = 'Revenir à la vue générale des rapports';
...
$string['clearall'] = 'Tout supprimer';
$string['clearalldata'] = 'Effacer toute les anciennes entrées';
$string['collect'] = 'Collecte';
$string['clearalladvice'] = 'En activant cette option vous supprimez toutes les entrées précédentes, mais aussi les données d\'opérateurs, les résultats et les notes des participants.';
...
$string['editareport'] = 'Rédiger ma synthèse';
$string['extragrading'] = 'Réglages supplémentaires de l\'évaluation';
$string['feedback'] = 'Feedback';
$string['feedbackfor'] = 'Feedback pour {$a}';
$string['feedbackweight'] = 'Poids de la note de réflexion ';
$string['seefeedback'] = 'Voir le feedback';
...
$string['globalfeedback'] = 'Feedback global';
$string['havereport'] = 'Ont rédigé une synthèse';
$string['half'] = 'Isolement partiel';
...
$string['importformat_help'] = 'Importez un fichier texte encodé en UTF-8 avec un énnoncé par ligne.';
...
$string['notsubmitted'] = 'Aucune idée pour l\'instant';
$string['noreports'] = 'Pas de synthèses déposées';
$string['nofeedback'] = 'Pas de feedback';
...
$string['reportfor'] = 'Synthèse de {$a}';
...
$string['seereport'] = 'Lire la synthèse';
$string['seefeedback'] = 'Lire le feedback';
$string['singlegrade'] = 'Note unique ';
$string['splittedgrade'] = 'Note dissociée ';
$string['summary'] = 'Résumé';
$string['teacherfeedback'] = 'Observation de l\'animateur';
$string['teacherphase'] = 'Phase enseignant. Pas de résultats étudiants ici.';
...
Ce module permet de construire une batterie d\'exercices basés sur la manipulation cognitive d\'énnoncés par des opérateurs comme le tri, le rangement, 
l\'ordonnancement, la hiérarchisation.  

Les exercices peuvent être réalisés en solitaire mais également en confrontation avec la classe ou le groupe.
';

$string['numcolumns_help'] = '
<p>Le nombre de colonnes verticales d\'affichage pour les entrées.</p>
';

$string['numinputs_help'] = '
<p>Le nombre nouvelles idées qui peuvent être proposées à chaque appel du formulaire de saisie.</p>
';

$string['oprequirementtype_help'] = '
<p>Vous pouvez imposer le type de saisie des idées parmi:</p>
<ul><li>Saisie d\'une phrase simple</li>
<li>Saisie d\'un paragraphe</li>
<li>Saisie d\'un contenu riche</li>
</ul>
';

$string['flowcontrol_help'] = '
<p><b>Mode de déroulement</b></p>
<p>Si ce paramètre est réglé sur "séquentiel", l\'étudiant n\'a accès qu\'à une seule phase à la fois, la phase est choisie pour tous les participants par l\'enseignant.</p>
<p>Si ce paramètre est réglé sur "parallèle", les étudiants peuvent à tout moment basculer sur l\'une des phases auxquelles ils ont accès.<\p>
';

$string['phaseattribution_help'] = '
<p><b>Attribution des phases</b></p>
<p>Ces paramètres permettent de déterminer lesquelles des phases sont contrôlées respectivement par l\'étudiant ou par les enseignants.</p>
<p>La nature cognitive de l\'exercice peut varier du tout au tout suivant ce choix.</p>
';

$string['gradeweights_help'] = '
<p><b>Barème dissocié</b></p>
<p>Il est possible de choisir une note unique pour tout l\'exercice, ou de dissocier la notation par phase. Ces paramètres permettent de donner, dans ce cas, la pondération des phases.</p>
';
