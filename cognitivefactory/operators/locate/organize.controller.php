...
if ($action == 'savelocations'){
    ...
    if (!delete_records('cognitivefactory_operatordata', 'cognitivefactoryid', $cognitivefactory->id, 'userid', $USER->id, 'operatorid', 'locate')){
    ...
    foreach($keys as $key){        
        ...
        if (!insert_record('cognitivefactory_operatordata', $locaterecord)){
